...
HOSPITAL_TRAIN_PHYSICAL_OBSTACLE_SLOTS = 16
HOSPITAL_TRAIN_ACTOR_SLOTS = HOSPITAL_TRAIN_PHYSICAL_OBSTACLE_SLOTS
...
HOSPITAL_TRAIN_OBSTACLE_NAMES = [
    f"obstacle_{i}" for i in range(HOSPITAL_TRAIN_PHYSICAL_OBSTACLE_SLOTS)
]

HOSPITAL_CLASS_WALL = 0
HOSPITAL_CLASS_VULNERABLE_HUMAN = 1
HOSPITAL_CLASS_GENERAL_HUMAN = 2
HOSPITAL_CLASS_PATIENT_EQUIPMENT = 3
HOSPITAL_CLASS_MOBILE_EQUIPMENT = 4
HOSPITAL_CLASS_STATIC_FURNITURE = 5
HOSPITAL_CLASS_LOW_MISC = 6
HOSPITAL_CLASS_COUNT = 7
HOSPITAL_SEMANTIC_CLASS_NAMES = (
    "wall",
    "vulnerable_human",
    "general_human",
    "patient_equipment",
...
HOSPITAL_AVOIDANCE_PRIORITY_WALL = 1.0
HOSPITAL_AVOIDANCE_PRIORITY_VULNERABLE = 1.0
HOSPITAL_AVOIDANCE_PRIORITY_GENERAL = 0.85
HOSPITAL_AVOIDANCE_PRIORITY_MOBILE_EQUIPMENT = 0.70
HOSPITAL_AVOIDANCE_PRIORITY_STATIC_FURNITURE = 0.50
HOSPITAL_AVOIDANCE_PRIORITY_LOW_MISC = 0.35

HOSPITAL_LABEL_CLASS_ID: dict[str, int] = {
    "wall": HOSPITAL_CLASS_WALL,
    "patient_ambulatory": HOSPITAL_CLASS_VULNERABLE_HUMAN,
    "elderly": HOSPITAL_CLASS_VULNERABLE_HUMAN,
    "child": HOSPITAL_CLASS_VULNERABLE_HUMAN,
    "queue_patient": HOSPITAL_CLASS_VULNERABLE_HUMAN,
    "seated_patient": HOSPITAL_CLASS_VULNERABLE_HUMAN,
    "doorway_patient": HOSPITAL_CLASS_VULNERABLE_HUMAN,
    "patient_with_iv": HOSPITAL_CLASS_PATIENT_EQUIPMENT,
    "wheelchair_patient": HOSPITAL_CLASS_PATIENT_EQUIPMENT,
    "gurney_patient": HOSPITAL_CLASS_PATIENT_EQUIPMENT,
    "adult": HOSPITAL_CLASS_GENERAL_HUMAN,
    "staff": HOSPITAL_CLASS_GENERAL_HUMAN,
    "visitor": HOSPITAL_CLASS_GENERAL_HUMAN,
    "queue_visitor": HOSPITAL_CLASS_GENERAL_HUMAN,
    "seated_visitor": HOSPITAL_CLASS_GENERAL_HUMAN,
    "doorway_staff": HOSPITAL_CLASS_GENERAL_HUMAN,
    "cart": HOSPITAL_CLASS_MOBILE_EQUIPMENT,
    "wheelchair": HOSPITAL_CLASS_MOBILE_EQUIPMENT,
    "gurney": HOSPITAL_CLASS_MOBILE_EQUIPMENT,
    "cleaning_machine": HOSPITAL_CLASS_MOBILE_EQUIPMENT,
    "chair": HOSPITAL_CLASS_STATIC_FURNITURE,
    "bench": HOSPITAL_CLASS_STATIC_FURNITURE,
    "table": HOSPITAL_CLASS_STATIC_FURNITURE,
    "reception_desk": HOSPITAL_CLASS_STATIC_FURNITURE,
    "trash_bin": HOSPITAL_CLASS_LOW_MISC,
    "fallen_object": HOSPITAL_CLASS_LOW_MISC,
    "iv_pole": HOSPITAL_CLASS_LOW_MISC,
    "dog": HOSPITAL_CLASS_LOW_MISC,
}

HOSPITAL_LABEL_AVOIDANCE_PRIORITY: dict[str, float] = {
    "wall": HOSPITAL_AVOIDANCE_PRIORITY_WALL,
    "patient_ambulatory": HOSPITAL_AVOIDANCE_PRIORITY_VULNERABLE,
    "elderly": HOSPITAL_AVOIDANCE_PRIORITY_VULNERABLE,
    "child": HOSPITAL_AVOIDANCE_PRIORITY_VULNERABLE,
    "queue_patient": HOSPITAL_AVOIDANCE_PRIORITY_VULNERABLE,
    "seated_patient": HOSPITAL_AVOIDANCE_PRIORITY_VULNERABLE,
    "doorway_patient": HOSPITAL_AVOIDANCE_PRIORITY_VULNERABLE,
    "patient_with_iv": HOSPITAL_AVOIDANCE_PRIORITY_VULNERABLE,
    "wheelchair_patient": HOSPITAL_AVOIDANCE_PRIORITY_VULNERABLE,
    "gurney_patient": HOSPITAL_AVOIDANCE_PRIORITY_VULNERABLE,
    "adult": HOSPITAL_AVOIDANCE_PRIORITY_GENERAL,
    "staff": HOSPITAL_AVOIDANCE_PRIORITY_GENERAL,
    "visitor": HOSPITAL_AVOIDANCE_PRIORITY_GENERAL,
    "queue_visitor": HOSPITAL_AVOIDANCE_PRIORITY_GENERAL,
    "seated_visitor": HOSPITAL_AVOIDANCE_PRIORITY_GENERAL,
    "doorway_staff": HOSPITAL_AVOIDANCE_PRIORITY_GENERAL,
    "cart": HOSPITAL_AVOIDANCE_PRIORITY_MOBILE_EQUIPMENT,
    "wheelchair": HOSPITAL_AVOIDANCE_PRIORITY_MOBILE_EQUIPMENT,
    "gurney": HOSPITAL_AVOIDANCE_PRIORITY_MOBILE_EQUIPMENT,
    "cleaning_machine": HOSPITAL_AVOIDANCE_PRIORITY_MOBILE_EQUIPMENT,
    "chair": HOSPITAL_AVOIDANCE_PRIORITY_STATIC_FURNITURE,
    "bench": HOSPITAL_AVOIDANCE_PRIORITY_STATIC_FURNITURE,
    "table": HOSPITAL_AVOIDANCE_PRIORITY_STATIC_FURNITURE,
    "reception_desk": HOSPITAL_AVOIDANCE_PRIORITY_STATIC_FURNITURE,
    "trash_bin": HOSPITAL_AVOIDANCE_PRIORITY_LOW_MISC,
    "fallen_object": HOSPITAL_AVOIDANCE_PRIORITY_LOW_MISC,
    "iv_pole": HOSPITAL_AVOIDANCE_PRIORITY_LOW_MISC,
    "dog": HOSPITAL_AVOIDANCE_PRIORITY_LOW_MISC,
}

HOSPITAL_LOW_OBSTACLE_HEIGHT_BUCKETS = (
    (0.10, 0.25),
    (0.25, 0.50),
    (0.50, 0.90),
    (1.00, 1.90),
)
HOSPITAL_LOW_OBSTACLE_FLAG_HEIGHT = HOSPITAL_LOW_OBSTACLE_HEIGHT_BUCKETS[2][1]
HOSPITAL_LOW_OBSTACLE_LABELS = ("fallen_object", "trash_bin", "chair")

HOSPITAL_MAZE_JUNCTION_COUNT = 25
HOSPITAL_TRAIN_CORRIDOR_WIDTH = 2.8
HOSPITAL_TRAIN_MIN_PATH_STEPS = 3
HOSPITAL_TRAIN_MAX_PATH_STEPS = 5
HOSPITAL_TRAIN_LONG_PATH_MAX_STEPS = 6
HOSPITAL_TRAIN_LONG_PATH_PROBABILITY = 0.15
HOSPITAL_TRAIN_MAX_ROUTE_LENGTH = 60.0
...
HOSPITAL_TRAIN_WALL_THICKNESS = 0.20
HOSPITAL_TRAIN_WALL_HEIGHT = 2.20
HOSPITAL_TRAIN_ATLAS_CELL_SPACING = 24.0
HOSPITAL_TRAIN_GRID_RESOLUTION = 0.20
HOSPITAL_TRAIN_ROBOT_INFLATION = 0.35
HOSPITAL_TRAIN_PASSAGE_WIDTH = 0.70
HOSPITAL_TRAIN_ACTOR_LATERAL_MARGIN = 0.08
HOSPITAL_TRAIN_ACTOR_LONGITUDINAL_MARGIN = 0.30
HOSPITAL_TRAIN_MIN_INTER_ACTOR_DIST = 1.5
HOSPITAL_TRAIN_CENTER_BLOCK_PROBABILITY = 0.45
HOSPITAL_TRAIN_CENTER_BLOCK_LATERAL_RANGE = 0.35
HOSPITAL_TRAIN_START_EXCLUSION_RADIUS = 1.7
HOSPITAL_TRAIN_GOAL_EXCLUSION_RADIUS = 1.0
HOSPITAL_TRAIN_PRIVILEGED_NEAREST_SLOTS = 8
HOSPITAL_PATH_FEATURE_DIM = 10
HOSPITAL_CORRIDOR_FEATURE_DIM = 8
HOSPITAL_SEMANTIC_FEATURE_DIM = 16

_HOSPITAL_TRAIN_ACTOR_SPECS = (
    ("cylinder", (0.50, 0.50), 1.70, "patient_ambulatory"),
    ("cuboid", (0.25, 0.35), 0.20, "fallen_object"),
    ("cylinder", (0.34, 0.34), 1.25, "child"),
    ("cuboid", (0.70, 1.00), 1.30, "wheelchair_patient"),
    ("cylinder", (0.46, 0.46), 1.60, "elderly"),
    ("cylinder", (0.32, 0.32), 0.75, "trash_bin"),
    ("cuboid", (1.95, 0.95), 1.20, "gurney_patient"),
    ("cylinder", (0.52, 0.52), 1.70, "patient_with_iv"),
    ("cylinder", (0.48, 0.48), 1.75, "staff"),
    ("cuboid", (0.60, 0.90), 1.05, "cart"),
    ("cuboid", (0.35, 0.55), 0.85, "chair"),
    ("cylinder", (0.22, 0.22), 1.45, "iv_pole"),
    ("cuboid", (0.55, 0.80), 0.75, "cleaning_machine"),
    ("cuboid", (1.20, 0.55), 0.50, "bench"),
    ("cylinder", (0.35, 0.35), 0.55, "dog"),
    ("cuboid", (0.80, 0.80), 0.75, "table"),
)
assert len(_HOSPITAL_TRAIN_ACTOR_SPECS) == HOSPITAL_TRAIN_ACTOR_SLOTS
HOSPITAL_TRAIN_OBSTACLE_SPECS = tuple(
    (shape_kind, footprint_size) for shape_kind, footprint_size, _, _ in _HOSPITAL_TRAIN_ACTOR_SPECS
)
HOSPITAL_TRAIN_OBSTACLE_SHAPE_IDS = tuple(
    _SHAPE_ID_BY_KIND[kind] for kind, _ in HOSPITAL_TRAIN_OBSTACLE_SPECS
)
HOSPITAL_TRAIN_OBSTACLE_WIDTHS = tuple(size[0] for _, size in HOSPITAL_TRAIN_OBSTACLE_SPECS)
HOSPITAL_TRAIN_OBSTACLE_DEPTHS = tuple(size[1] for _, size in HOSPITAL_TRAIN_OBSTACLE_SPECS)
HOSPITAL_TRAIN_OBSTACLE_HEIGHTS = tuple(
    height for _, _, height, _ in _HOSPITAL_TRAIN_ACTOR_SPECS
)
HOSPITAL_TRAIN_OBSTACLE_CENTER_ZS = tuple(
    height * 0.5 + OBSTACLE_GROUND_CLEARANCE for height in HOSPITAL_TRAIN_OBSTACLE_HEIGHTS
)
HOSPITAL_TRAIN_OBSTACLE_LABELS = tuple(
    label for _, _, _, label in _HOSPITAL_TRAIN_ACTOR_SPECS
)
HOSPITAL_TRAIN_OBSTACLE_CLASS_IDS = tuple(
    HOSPITAL_LABEL_CLASS_ID[label] for label in HOSPITAL_TRAIN_OBSTACLE_LABELS
)
HOSPITAL_TRAIN_OBSTACLE_PRIORITIES = tuple(
...
def hospital_class_id(label: str) -> int:
    ...
    return HOSPITAL_LABEL_CLASS_ID.get(label, HOSPITAL_CLASS_LOW_MISC)


def hospital_avoidance_priority(label: str) -> float:
    """Return the normalized teacher-only avoidance priority for a hospital label."""
    return HOSPITAL_LABEL_AVOIDANCE_PRIORITY.get(label, HOSPITAL_AVOIDANCE_PRIORITY_LOW_MISC)
...
NAV_WAYPOINT_GOAL_SNAP_DISTANCE = 0.45
...
HOSPITAL_RAYCAST_MAX_DISTANCE = 10.0
HOSPITAL_RAYCAST_HORIZONTAL_FOV = (0.0, 360.0)
HOSPITAL_RAYCAST_HORIZONTAL_RES = 5.0
HOSPITAL_RAYCAST_CHANNELS = 3
HOSPITAL_RAYCAST_VERTICAL_FOV = (-20.0, -3.0)
HOSPITAL_RAYCAST_SENSOR_OFFSET = (0.0, 0.0, 0.20)
