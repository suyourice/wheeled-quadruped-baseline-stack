...
# Optional: VisuoTactileSensorCfg from isaaclab_contrib (not required for go2w).
try:
    from isaaclab_contrib.sensors.tacsl_sensor import VisuoTactileSensorCfg

    _has_visuo_tactile = True
except ModuleNotFoundError:
    VisuoTactileSensorCfg = None
    _has_visuo_tactile = False
    ...
    def _add_entities_from_cfg(self):
        ...
        for asset_name, asset_cfg in self.cfg.__dict__.items():
            ...
            if isinstance(asset_cfg, TerrainImporterCfg):
                ...
                elif _has_visuo_tactile and isinstance(asset_cfg, VisuoTactileSensorCfg):
